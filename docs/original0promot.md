...
> - Items, with the Item Code in Column A, and the remaining columns showing item-specific attributes such as Brand, Category, Gender, Type, Size, Description, Retail Price, Personalities, Color, and Scent.  Note that some items have a blank or 0 retail price - these are samples or testers that are frequently shipped to brick and morter retailers to help promote sales at the fragrance counter.
